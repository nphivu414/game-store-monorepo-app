    ...
    <>
      ...
      <SafeAreaView>
        ...
        >
          ...
          <View style={styles.section}>
            <View style={[styles.middleContent, styles.shadowBox]}>
              ...
              <TouchableOpacity
                ...
                onPress={() => openURLInBrowser('https://nx.dev/getting-started/intro?utm_source=nx-project')}
              >
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => openURLInBrowser('https://blog.nrwl.io/?utm_source=nx-project')}
              >
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => openURLInBrowser('https://www.youtube.com/c/Nrwl_io/videos?utm_source=nx-project')}
              >
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => openURLInBrowser('https://nx.dev/tutorial/01-create-application?utm_source=nx-project')}
              >
              ...
              <TouchableOpacity
                style={[styles.listItem, styles.learning]}
                onPress={() => openURLInBrowser('https://nxplaybook.com/?utm_source=nx-project')}
              >
          ...
          <View style={styles.section}>
            ...
            >
              <View style={[styles.listItem, styles.shadowBox]}>
                ...
                <View style={styles.listItemTextContainer}>
                  <Text style={[styles.textMd, styles.textBold, styles.marginBottomSm]}>Install Nx Console</Text>
          ...
          <View style={styles.section}>
            <TouchableOpacity onPress={() => openURLInBrowser('https://nx.app/?utm_source=nx-project')}>
          ...
          >
            <View style={styles.shadowBox}>
              ...
              <View style={[styles.codeBlock, styles.marginBottomLg]}>
                ...
                <Text style={[styles.textXS, styles.monospace]}>@nrwl/react-native:component \</Text>
              ...
              <View style={styles.codeBlock}>
                ...
                <Text style={[styles.textXS, styles.monospace, styles.marginBottomMd]}>nx affected:dep-graph</Text>
